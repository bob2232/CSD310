...
GRANT ALL ON outlandadventures.trip_location TO 'John_MacNell'@'localhost';
GRANT ALL ON outlandadventures.trip_location TO 'D.B._Marland'@'localhost';
...
GRANT ALL ON outlandadventures.equipment TO 'Dimitrios_Stravopolous'@'localhost';
