...
-- create users and grant them all privileges to the outlandadventures database 
CREATE USER 'Blythe_Timmerson'@'localhost' IDENTIFIED BY 'outdoor';
CREATE USER 'Jim_Ford'@'localhost' IDENTIFIED BY 'outdoor';
CREATE USER 'John_MacNell'@'localhost' IDENTIFIED BY 'outdoor';
CREATE USER 'D.B._Marland'@'localhost' IDENTIFIED BY 'outdoor';
CREATE USER 'Anita_Gallegos'@'localhost' IDENTIFIED BY 'outdoor';
CREATE USER 'Dimitrios_Stravopolous'@'localhost' IDENTIFIED BY 'outdoor';
CREATE USER 'Mei_Wong'@'localhost' IDENTIFIED BY 'outdoor';
...
GRANT ALL ON outlandadventures.* TO 'John_MacNell'@'localhost';
GRANT ALL ON outlandadventures.* TO 'D.B._Marland'@'localhost';
GRANT ALL ON outlandadventures.* TO 'Anita_Gallegos'@'localhost';
GRANT ALL ON outlandadventures.* TO 'Dimitrios_Stravopolous'@'localhost';
GRANT ALL ON outlandadventures.* TO 'Mei_Wong'@'localhost';
